                ...
                <div class="col-lg-8">
                    <div class="d-flex">
                        ...
                        <div style="margin-left: auto">
                            <a href="{{ route('posts.edit', ['post' => $post->id])}}" class="btn btn-sm btn-outline-dark">
                                Edit
                            </a>
                            <form action="{{ route('posts.destroy',['post' => $post->id])}}"
                                method="POST"
                                onsubmit="return confirm('Rostan ham o\'chirmoqchisizmi.')">
                                @csrf
                                @method('DELETE')
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                            <img class="img-fluid rounded" src="/storage/{{ $item->photo }}" style="width: 80px; height: 80px; object-fit: cover;" alt="">
